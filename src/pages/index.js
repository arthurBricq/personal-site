...
export default function Home({data}) {
  ...
  return (
    <Layout>
      ...
      <p>Discover some of my <strong>projects</strong> at this <Link to="/projects">Project Explorer Page</Link>.</p>

      <p>You can find my <strong>resume</strong> in the <Link to="/about">Contact Page</Link>.</p>
      ...
      <p><i>I am currently looking for an internship (4 to 6 months), starting on August / September.</i></p>
      ...
      <p>Being quite concerned about the climate problems, I try to care about my environmental footprint. I believe that science has a big role to play in the incoming years to 'save' our planet. In my hopes, there is at the jonction of Low-Techs and High-Techs a set of local solutions that could be the keys to many troubles.</p>
    </Layout>
  )
}
...
export const query = graphql`
  query {
    imageOne: file(relativePath: { eq: "images/self4.jpeg" }) {
      childImageSharp {
